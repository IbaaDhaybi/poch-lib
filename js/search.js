...
function searchBooks() {
    ...
    if (valid) {
        ...
        $.ajax({
            type: "GET",
            url: "https://www.googleapis.com/books/v1/volumes?q=inauthor:" + author + "+intitle:" + title + "&key=AIzaSyAcdIrqYKZEZPqjTNo_8-R5iZoSUcdM2qA",
            dataType: 'json',
...
function displayBooks(booksReponse) {
